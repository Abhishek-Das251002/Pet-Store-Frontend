...
const Checkout = () => {
    ...
    const {data,loading, error} = useFetch("https://pet-store-backend-olive.vercel.app/products")
    ...
    async function handleForm(e){
        ...
        if(itemId){
            try {
            const response = await fetch('https://pet-store-backend-olive.vercel.app/orders/history', {
            method: 'POST',
            body: JSON.stringify({ 
                orderId : orderId,
